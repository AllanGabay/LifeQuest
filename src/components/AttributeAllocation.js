...
const explanations = {
  ...
  "Efficacité": "Efficacité (Discipline du Maître du Temps)\n\nEfficacité est l'attribut du héros capable d'accomplir ses quêtes rapidement et avec précision. Elle représente ta capacité à organiser et réaliser tes tâches avec fluidité. Plus tu développes cette compétence, plus tu réduis les délais et maximises ton rendement. Les guerriers les plus efficaces planifient leur journée comme des généraux avant une bataille et exécutent leurs plans sans laisser de place au hasard.",
  "Maîtrise": "Maîtrise (Savoir et Technique)\n\nLa Maîtrise te permet de débloquer des compétences spéciales et de développer ton expertise dans plusieurs domaines. C'est l'alliée des érudits et des artisans. Plus tu accumules de connaissances et pratiques tes compétences, plus tu deviens un maître de ton art. Que tu sois en quête de nouvelles connaissances théoriques ou de compétences pratiques, cette catégorie reflète ton avancée vers la perfection.",
